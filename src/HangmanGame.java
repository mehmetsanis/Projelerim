...
public class HangmanGame {
    public static void main(String[] args) {
        ...
        {
            System.out.println(hangmanInstance.getSecret());
            ...
            System.err.println("Number:  " + hangmanInstance.getNumOfIncorrectTries());
            System.out.println(secretWord.equals(hangmanInstance.getKnownSoFar()));
